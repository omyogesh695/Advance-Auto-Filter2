...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⚡ How To Download ⚡", url=f"https://t.me/how_to_open_pkinme")
    ])
    try:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
            ...
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                if clicked == typed:
                    await client.send_cached_media(
                        ...
                        [
                         [InlineKeyboardButton('⚡ Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ ⚡', url='https://t.me/Marathimovieloverz'),
                          InlineKeyboardButton('🔗 Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ 🔗', url='https://t.me/Visionloverz')
                       ],[
                          InlineKeyboardButton("📣 Bᴏᴛ Oᴡɴᴇʀ 📣", url="t.me/Vlzrobot")
                         ]
                        ]
                    )
                )
        ...
        buttons = [[
            ...
            InlineKeyboardButton(
                '🏆 Group 🏆', url='https://t.me/Marathimovieloverz'),
            InlineKeyboardButton(
                '📣 Updates 📣', url='https://t.me/Visionloverz')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('⚡ Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ ⚡', url='https://t.me/Marathimovieloverz'),
            InlineKeyboardButton('🔗 Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ 🔗', url='https://t.me/Visonloverz')
        ],[
            InlineKeyboardButton('Hᴏᴍᴇ', callback_data='start'),
